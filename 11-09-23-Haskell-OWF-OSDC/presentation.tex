...
Idée : \verb|putStr :: String → ()|

\pause

Problème : \verb|swap :: Stack w → Stack w|

\pause

Problème : \verb|[putStr "oui", putStr "non"]|

\pause

Solution : actions IO, i.e. valeurs de type \verb|IO t|

\pause

\verb|type IO a = RealWorld → (a, RealWorld)|
